---
title: Ibadah Kurban dan Perubahan Iklim
authors: priyadi
...
metana](https://en.wikipedia.org/wiki/Methane) (CH<sub>4</sub>) sebagai produk
sampingan.
...
daripada karbon dioksida (CO<sub>2</sub>). Dalam 20 tahun pertama setelah
dilepaskan, metana memiliki potensi pemanasan global sekitar 84-87 kali lebih
besar daripada CO<sub>2</sub>. Oleh karena itu, emisi metana dari peternakan
hewan merupakan kontributor
signifikan terhadap perubahan iklim.

![Emisi metana dari peternakan](./emisi_grk_per_protein_svg_id.svg)

100 gram protein yang berasal dari daging sapi menghasilkan [efek gas rumah kaca
yang setara dengan sekitar 50 kg
CO<sub>2</sub>](https://pubmed.ncbi.nlm.nih.gov/29853680/). Ini lebih dari dua kali
...
Sebagai perbandingan, kendaraan bensin menghasilkan emisi sekitar 250g CO<sub>2</sub>eq per
...
![Perbandingan emisi gas rumah kaca](./ghg.png)
